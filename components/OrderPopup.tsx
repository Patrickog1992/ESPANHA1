...
const OrderPopup: React.FC<OrderPopupProps> = ({ onClose }) => {
  ...
  return (
    <div className="flex items-center justify-center font-poppins w-full">
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden relative min-h-[500px] flex flex-col border border-gray-100 animate-in fade-in zoom-in duration-300">
        
        {/* Close Button */}
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 z-20 text-gray-400 hover:text-gray-600 bg-white/50 rounded-full p-1 transition-colors"
        ...
        <div className="p-6 md:p-8 flex-grow flex flex-col justify-center mt-4">
